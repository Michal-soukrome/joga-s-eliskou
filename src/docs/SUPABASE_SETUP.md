...
-- Create policy to allow all authenticated operations (admin)
...
### Video Lessons Table (for future use)
...
-- Create policy to allow all operations (admin)
...
5. Copy and paste the gallery_images table SQL above
6. Click "Run"
7. (Optional) Repeat for video_lessons table
8. Done! The tables are ready

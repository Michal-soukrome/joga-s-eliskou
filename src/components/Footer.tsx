...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-tr from-sky-50/50 via-white to-sky-100/50 text-sky-600 py-14 px-6 border-t border-sky-100">
      <Container>
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm leading-relaxed max-w-sm">
              Certifikovaná instruktorka jógy. Lekce pro začátečníky i pokročilé
              - síla, mobilita a dech v jednom pohybu.
            </p>
          </div>
